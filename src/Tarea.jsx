  ...
  return (
    <div className="tarea">
        ...
        <button className="boton" onClick={ async () => {
          ...
          if(editando){
            if(tareaTemporal.trim() != "" && tareaTemporal.trim() != tarea){
              let {resultado,error} = await fetch(`https://api-todo-mongo-h5cs.onrender.com/tareas/actualizar/${id}/1`,{
                method : "PUT",
        ...
        <button className="boton" onClick={ () => {
          ...
          fetch("https://api-todo-mongo-h5cs.onrender.com/tareas/borrar/" + id, {
            method : "DELETE"
          })
          .then(respuesta => respuesta.json())
        ...
        <button className={`estado ${estado ? "terminada" : ""}`} onClick={ () => {
          ...
          fetch(`https://api-todo-mongo-h5cs.onrender.com/tareas/actualizar/${id}/2`,{
            method : "PUT"
          })
          .then(respuesta => respuesta.json())
          .then(({resultado,error}) => {
